                ...
                <div class="col-lg-8">
                    ...
                    <div class="wrap-review">
                        <div class="pb-12 line-b mb-0">
                            <h5 class="text-black-2">Comment (4)</h5>
                        </div>
                        <ul class="box-review">
                    ...
                    <div class="wrap-form-comment">
                        <h5 class="text-black-2">Leave A comment</h5>
                        <p class="text-variant-1 mt-8">Your email address will not be published. Required fields are marked *</p>
                                ...
                                <form method="post" id="contactform" class="comment-form form-submit" action="./contact/contact-process.php" accept-charset="utf-8" novalidate="novalidate">
                                    ...
                                    <div class="form-wg group-ip">
                                        <fieldset>
                                            ...
                                            <input type="text" class="form-control" name="text" placeholder="Your name" required="" spellcheck="false" data-ms-editor="true">
                                        </fieldset>
                                        <fieldset>
                                    ...
                                    <fieldset class="form-wg">
                                        ...
                                        <textarea id="comment-message" name="message" rows="4" tabindex="4" placeholder="Write comment " aria-required="true" spellcheck="false" data-ms-editor="true"></textarea>
                                    </fieldset>
                        ...
                        <div class="widget-box recent">
                            ...
                            <ul>
                                @foreach($featuredPosts as $featured)
                                    <li>
                                        <a href="{{ route('blog-details-manager', ['postId' => $featured->id]) }}" class="recent-post-item not-overlay hover-img">
                                            <div class="img-style">
