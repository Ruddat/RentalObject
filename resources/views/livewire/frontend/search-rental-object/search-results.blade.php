...
<section class="flat-section flat-recommended flat-sidebar">
    <div class="container">
        <div class="box-title-listing">
            <div class="box-left">
                <h3 class="fw-8">@autotranslate("Property Listing", app()->getLocale())</h3>
                <p class="text">@autotranslate("There are currently", app()->getLocale()) 164,814 @autotranslate("properties.", app()->getLocale())</p>
            </div>
            ...
            <div class="col-xl-4 col-lg-5">
                ...
                <div id="filters" class="widget-sidebar fixed-sidebar d-none d-lg-block">
                                            ...
                                            <div class="inner-group">
                                                <div class="box">
                                                    <div class="form-style">
                                                        <input type="text" wire:model="keyword" class="form-control" placeholder="Type keyword...." value="{{ $keyword }}" name="s" title="Search for" required="">
                                                    </div>
                                                    <div class="form-style">
                                                    ...
                                                    <div class="form-style">
                                                        ...
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0">
                                                                <span class="current">
                                                                    {{ $selectedType === 'all' ? 'All' : ($propertyTypes->firstWhere('id', $selectedType)->name ?? 'Property Type') }}
                                                                </span>
                                                                <ul class="list">
                                                                    <li data-value="all"
                                                                        class="option {{ $selectedType === 'all' ? 'selected' : '' }}"
                                                                        wire:click="$set('selectedType', 'all')">
                                                                        All
                                                                    </li>
                                                                    @foreach($propertyTypes as $type)
                                                                        <li data-value="{{ $type->id }}"
                                                                            class="option {{ (string)$selectedType === (string)$type->id ? 'selected' : '' }}"
                                                                            wire:click="$set('selectedType', '{{ $type->id }}')">
                                                                            {{ $type->name }}
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                    ...
                                                    <div class="form-style box-select">
                                                        <div class="nice-select" tabindex="0">
                                                            <span class="current">
                                                                {{ $rooms === null ? 'Select Rooms' : $rooms }}
                                                            </span>
                                                            <ul class="list">
                                                                <li data-value=""
                                                                    class="option {{ $rooms === null ? 'selected' : '' }}"
                                                                    wire:click="$set('rooms', null)">
                                                                    @autotranslate("Select Rooms", app()->getLocale())
                                                                </li>
                                                                @for ($i = 0; $i <= 10; $i++)
                                                                    <li data-value="{{ $i }}"
                                                                        class="option {{ (string)$rooms === (string)$i ? 'selected' : '' }}"
                                                    ...
                                                    <div class="form-style box-select">
                                                        <div class="nice-select" tabindex="0">
                                                            <span class="current">
                                                                {{ $bathrooms === null ? 'Select Bathrooms' : $bathrooms }}
                                                            </span>
                                                            <ul class="list">
                                                                <li data-value=""
                                                                    class="option {{ $rooms === null ? 'selected' : '' }}"
                                                                    wire:click="$set('bathrooms', null)">
                                                                    @autotranslate("Select Bathrooms", app()->getLocale())
                                                                </li>
                                                                @for ($i = 0; $i <= 10; $i++)
                                                                    <li data-value="{{ $i }}"
                                                                        class="option {{ (string)$bathrooms === (string)$i ? 'selected' : '' }}"
                                                            ...
                                                            <div class="group-amenities">
                                                                @foreach($amenities as $amenity)
                                                                    <fieldset class="amenities-item">
                                                                        ...
                                                                        <label for="amenity-{{ $amenity->id }}" class="text-cb-amenities">
                                                                            {{ $amenity->name }}
                                                                        </label>
                                                                    </fieldset>
                                                                @endforeach
                    ...
                    <div class="widget-box box-latest-property">
                        <h5 class="fw-6 title">@autotranslate("Latest Propeties", app()->getLocale())</h5>
                        <ul>
                            <li class="latest-property-item">
                                <a href="property-details-v1.html" class="images-style">
                                    <img src="{{ URL::asset('/build/images/home/house-8.jpg') }}" alt="img">
                                </a>
                                <div class="content">
                            ...
                            <li class="latest-property-item">
                                <a href="property-details-v1.html" class="images-style">
                                    <img src="{{ URL::asset('/build/images/home/house-3.jpg') }}" alt="img">
                                </a>
                                <div class="content">
                                    <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                    <ul class="meta-list mt-6">
                            ...
                            <li class="latest-property-item">
                                <a href="property-details-v1.html" class="images-style">
                                    <img src="{{ URL::asset('/build/images/home/house-28.jpg') }}" alt="img">
                                </a>
                                <div class="content">
                                    <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                    <ul class="meta-list mt-6">
                            ...
                            <li class="latest-property-item">
                                <a href="property-details-v1.html" class="images-style">
                                    <img src="{{ URL::asset('/build/images/home/house-29.jpg') }}" alt="img">
                                </a>
                                <div class="content">
                                    <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                    <ul class="meta-list mt-6">
                            ...
                            <li class="latest-property-item">
                                <a href="property-details-v1.html" class="images-style">
                                    <img src="{{ URL::asset('/build/images/home/house-19.jpg') }}" alt="img">
                                </a>
                                <div class="content">
                                    <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                    <ul class="meta-list mt-6">
                                        ...
                                        <a href="property-details-v1.html" class="images-group">
                                            ...
                                            <div class="top">
                                                <ul class="d-flex gap-6">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                                                    <li class="flag-tag style-1">@autotranslate("For Sale", app()->getLocale())</li>
                                                </ul>
                            ...
                            <div class="col-md-6">
                                <div class="homelengo-box">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-30.jpg') }}" src="{{ URL::asset('/build/images/home/house-30.jpg') }}" alt="img">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-6">
                                <div class="homelengo-box">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-31.jpg') }}" src="{{ URL::asset('/build/images/home/house-31.jpg') }}" alt="img">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-11.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-11.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-12.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-12.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-13.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-13.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-14.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-14.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-15.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-15.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-16.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-16.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-17.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-17.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-18.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-18.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
                            ...
                            <div class="col-md-12">
                                <div class="homelengo-box list-style-1 list-style-2 line">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-19.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-19.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">@autotranslate("Featured", app()->getLocale())</li>
