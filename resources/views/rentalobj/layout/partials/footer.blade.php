    ...
    <div class="top-footer">
        <div class="container">
            <div class="content-footer-top">
                ...
                <div class="wd-social">
                    <span>@autotranslate("Folge uns:", app()->getLocale())</span>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-cl-1">
                        <p class="text-variant-2">@autotranslate("Spezialisiert auf die Bereitstellung von hochklassigen Touren für Bedürftige. Kontaktiere uns", app()->getLocale())</p>
                        <ul class="mt-12">
            ...
            @endforeach
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-cl-4 footer-col-block">
                        ...
                        <div class="tf-collapse-content">
                            <p class="mt-12 text-variant-2">@autotranslate("Dein wöchentlicher/monatlicher Wissens- und Inspirationsdosis", app()->getLocale())</p>
                            <form class="mt-12" id="subscribe-form" action="#" method="post" accept-charset="utf-8" data-mailchimp="true">
                                <div id="subscribe-content">
                                    <input type="email" name="email-form" id="subscribe-email" placeholder="@autotranslate("Deine E-Mail-Adresse", app()->getLocale())"/>
        ...
        <div class="container">
            <div class="content-footer-bottom">
                ...
                <ul class="menu-bottom">
                    ...
                    <li><a href="contact.html">@autotranslate("Cookie-Richtlinie", app()->getLocale())</a> </li>
                </ul>
            </div>
        </div>
    </div>
