...
<body class="body counter-scroll">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                    ...
                                                    <ul class="navigation clearfix">
                                                        <li class="dropdown2 home current"><a href="#">Home</a>
                                                            <ul>
                                                                ...
                                                                <li class="current"><a href="home-04.html">Homepage 04</a></li>
                                            ...
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-25.jpg" src="images/home/house-25.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-26.jpg" src="images/home/house-26.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-27.jpg" src="images/home/house-27.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-28.jpg" src="images/home/house-28.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-29.jpg" src="images/home/house-29.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
            ...
            <!-- End Recommended -->
            <!-- Service -->
            <section class="mx-10 flat-section bg-primary-new radius-30">
                <div class="flat-img-with-text style-2">
                    <div class="content-left position-relative">
                        <div class="img-wrap img-animation wow">
                            <img class="lazyload" data-src="images/banner/img-w-text3.jpg" src="images/banner/img-w-text3.jpg" alt="">
                        </div>
                        <div class="box-count">
                            <div class="count-item ani5">
                                <div class="avatar avt-56 avt-status">
                                ...
                                <div class="content">
                                    <div class="tf-counter">
                                        <h4 class="text-primary d-flex">
                                            <span class="number" data-speed="2000" data-to="480" data-inviewport="yes">480</span>k+
                                        </h4>
                                    </div>
                                    <div class="title text-line-clamp-1">Partner</div>
                                </div>
                            </div>
                            <div class="count-item ani4">
                                ...
                                <div class="content">
                                    <div class="tf-counter">
                                        <h4 class="text-primary d-flex">
                                            <span class="number" data-speed="2000" data-to="2.5" data-dec="1" data-inviewport="yes">2,5</span>k+
                                        </h4>
                                    </div>
                                    <div class="title text-line-clamp-1">Property Available</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="content-right">
                        <div class="box-title wow fadeInUp">
                            <div class="text-subtitle text-primary">What We Do</div>
                            <h4 class="mt-4">Discover What Sets Our</h4>
                            <p class="desc text-variant-1">At Home Lengo, our unwavering commitment lies in crafting unparalleled real estate journeys.</p>
                        </div>
            ...
            <!-- End Service -->
            <!-- Location -->
            <section class="flat-section flat-location px-10">
                <div class="box-title text-center wow fadeInUp">
            ...
            <!-- End Location -->
            <!-- Agents -->
            <section class="flat-section flat-agents pt-0">
                <div class="container">
                    <div class="box-title text-center wow fadeInUp">
                        <div class="text-subtitle text-primary">Our Teams</div>
                        <h3 class="title mt-4">Meet Our Agents</h3>
                    </div>
                    <div class="swiper tf-sw-mobile"  data-screen="575" data-preview="1" data-space="15">
            ...
            <section class="mx-10 flat-section bg-primary-new radius-30">
                <div class="flat-img-with-text style-2">
                    <div class="content-left img-animation wow">
                        <img class="lazyload" data-src="images/banner/img-w-text4.jpg" src="images/banner/img-w-text4.jpg" alt="">
                    </div>
                    <div class="content-right">
                        <div class="box-title wow fadeInUp">
                        ...
                        <div class="flat-property-box wow fadeInUp" data-wow-delay=".2s">
                            <div class="archive-top">
                                ...
                                <h4 class="title"><a href="property-details-v1.html" class="link">Rancho Vista Verde, Santa Barbara</a></h4>
                                <ul class="meta-list">
                                    <li class="item">
                                        <i class="icon icon-bed"></i>
                                        <span class="text-variant-1">Beds:</span>
            ...
            <section class="flat-section">
                <div class="container">
                    ...
                    <div class="swiper tf-sw-testimonial" data-preview="3" data-tablet="2" data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="30" data-centered="false" data-loop="false">
                    ...
                    <div class="swiper tf-sw-latest" data-preview="3" data-tablet="2" data-mobile-sm="2" data-mobile="1" data-space-lg="30" data-space-md="15" data-space="15">
                        <div class="swiper-wrapper wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="swiper-slide">
                                <a href="blog-detail.html" class="flat-blog-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload" data-src="images/blog/blog-7.jpg" src="images/blog/blog-7.jpg" alt="img-blog">
                                        <span class="date-post">January 28, 2024</span>
                                    </div>
                                    <div class="content-box">
                                        <div class="post-author">
                            ...
                            <div class="swiper-slide">
                                <a href="blog-detail.html" class="flat-blog-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload" data-src="images/blog/blog-9.jpg" src="images/blog/blog-9.jpg" alt="img-blog">
                                        <span class="date-post">January 28, 2024</span>
                                    </div>
                                    <div class="content-box">
                                        <div class="post-author">
