...
<body class="body">
            ...
            <!-- Slider -->
            <section class="flat-slider home-2 bg-primary-new">
                <div class="container relative">
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="slider-content">
                                <div class="heading">
                                    <h1 class="fw-8 title animationtext clip">Find A Home That
                                        <br>
                                        <span class="tf-text s1 cd-words-wrapper">
                                            <span class="item-text is-visible">Fits Perfectly</span>
                                            <span class="item-text is-hidden">Fits Dream Home</span>
                                        </span>
                                    </h1>
                                    <p class="subtitle body-2 wow fadeInUp" data-wow-delay=".2s">We are a real estate agency that will help you find the best <br>
                                ...
                                <div class="flat-tab flat-tab-form">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" role="tabpanel">
                                            <div class="form-sl">
                                                <form method="post">
                                                    <div class="wd-find-select style-2">
                                ...
                                <div class="wrap-search-link">
                                    <p class="body-2">What are you looking for:</p>
                ...
                <div class="img-banner-left">
                    <img src="{{ URL::asset('/build/images/slider/graplic-slider-2.png') }}" alt="img">
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="slider-home2 img-animation wow">
                                    <img src="{{ URL::asset('/build/images/slider/slider-2.jpg') }}" alt="images">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="slider-home2">
                                    <img src="{{ URL::asset('/build/images/slider/slider-2-1.jpg') }}" alt="images">
                                </div>
                            </div>

                            <div class="swiper-slide">
                                <div class="slider-home2">
                                    <img src="{{ URL::asset('/build/images/slider/slider-2-3.jpg') }}" alt="images">
                                </div>
                            </div>
            ...
            <section class="flat-section flat-categories">
                <div class="container">
                    <div class="box-title style-1 wow fadeInUp">
                    ...
                    <div class="wrap-categories-sw wow fadeInUp" data-wow-delay=".2s">
                        <div class="swiper tf-sw-categories sw-over" data-preview="6" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space="15" data-space-md="30" data-space-lg="30">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="#" class="homelengo-categories">
                                        <div class="icon-box">
            ...
            <section class="flat-section flat-recommended pt-0">
                <div class="container">
                    <div class="box-title text-center wow fadeInUp">
                        ...
                        <h3 class="title mt-4">Discover Homelengo's Finest Properties
                                            ...
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-13.jpg') }}" src="{{ URL::asset('/build/images/home/house-13.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-14.jpg') }}" src="{{ URL::asset('/build/images/home/house-14.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-15.jpg') }}" src="{{ URL::asset('/build/images/home/house-15.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-16.jpg') }}" src="{{ URL::asset('/build/images/home/house-16.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-17.jpg') }}" src="{{ URL::asset('/build/images/home/house-17.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-18.jpg') }}" src="{{ URL::asset('/build/images/home/house-18.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                    ...
                    <div class="flat-img-with-text-v2">
                            ...
                            <div class="grid-img-group">
                                <div class="tf-image-wrap item-1">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/banner/img-w-text-sm1.jpg') }}" src="{{ URL::asset('/build/images/banner/img-w-text-sm1.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="tf-image-wrap item-2">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/banner/img-w-text2.jpg') }}" src="{{ URL::asset('/build/images/banner/img-w-text2.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="tf-image-wrap item-3">
                                    <div class="img-style hover-img-wrap">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/banner/img-w-text-sm2.jpg') }}" src="{{ URL::asset('/build/images/banner/img-w-text-sm2.jpg') }}" alt="">
                                    </div>
                        ...
                        <div class="content-right">
                            <div class="box-title wow fadeInUp">
                                ...
                                <p class="desc text-variant-1">Our seasoned professionals, armed with extensive market knowledge, walk alongside you through every phase of your property endeavor.</p>
                            </div>
                            <div class="flat-service wow fadeInUp" data-wow-delay=".2s">
                                <a href="#" class="box-benefit hover-btn-view">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="btn-view style-1"><span class="text">Explore Now</span> <span class="icon icon-arrow-right2"></span> </span>
                                    </div>
                                </a>
                                <a href="#" class="box-benefit hover-btn-view">
                                    <div class="icon-box">
                                        <span class="icon">
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M53.25 19.3125C55.875 18 57.9375 15.5625 58.5 12.4687C59.5312 7.21875 56.1562 2.15625 50.9062 1.125C45.6562 0.0937479 40.5937 3.46875 39.5625 8.71875V8.8125C39 11.7187 39.8437 14.625 41.5312 16.7812" stroke="#1563DF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                </g>
                                                <defs>
                                    ...
                                    <div class="icon-box">
                                        <span class="icon">
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M47.3438 45.375V59.0625H5.625V39.1875M26.625 14.3438C26.3437 14.25 26.0625 14.3437 25.7812 14.5312L5.34375 35.0625C4.3125 36.0938 2.71875 36.0938 1.6875 35.0625C1.21875 34.5938 0.9375 33.9375 0.9375 33.2813C0.9375 32.625 1.21875 31.9687 1.6875 31.5L22.2188 10.9687C23.7188 9.46875 25.7812 8.90625 27.6562 9.375M0.9375 59.0625H52.0312" stroke="#1563DF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M33.6563 51.75V44.0625C33.6563 42.0938 32.8125 40.3125 31.5 39C30.1875 37.6875 28.4062 36.8437 26.4375 36.8437C22.5 36.8437 19.2187 40.0312 19.2187 44.0625V51.75M36.8437 58.0313V59.0625H16.125V58.0313C16.125 56.625 17.25 55.5 18.6562 55.5H34.3125C35.7187 55.5 36.8437 56.625 36.8437 58.0313ZM59.0625 15.2812C59.0625 20.8125 51.9375 33.375 47.8125 40.4062C46.4062 42.6562 43.125 42.6562 41.7187 40.4062C37.5 33.4687 30.4687 20.9062 30.4687 15.2812C30.375 7.3125 36.8438 0.9375 44.7188 0.9375C52.5937 0.9375 59.0625 7.3125 59.0625 15.2812Z" stroke="#1563DF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M44.7187 24.4688C49.7929 24.4688 53.9062 20.3554 53.9062 15.2812C53.9062 10.2071 49.7929 6.09375 44.7187 6.09375C39.6446 6.09375 35.5312 10.2071 35.5312 15.2812C35.5312 20.3554 39.6446 24.4688 44.7187 24.4688Z" stroke="#1563DF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M22.6875 46.2188V48.0938V46.2188Z" fill="black"/>
                                                <path d="M22.6875 46.2188V48.0938" stroke="#1563DF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                </g>
                                                <defs>
            ...
            <section class="flat-section flat-location-v2">
                <div class="container">
                    ...
                    <div class="grid-location wow fadeInUp" data-wow-delay=".2s">
                        <a href="topmap-grid.html" class="item-1 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-7.jpg') }}" src="{{ URL::asset('/build/images/location/location-7.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">Cape Town, South Africa</h6>
                                <p class="mt-4 text-variant-1">221 Property</p>
                            </div>

                        </a>
                        <a href="topmap-grid.html" class="item-2 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-8.jpg') }}" src="{{ URL::asset('/build/images/location/location-8.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">Seoul, South Korea</h6>
                                <p class="mt-4 text-variant-1">128 Property</p>
                            </div>
                        </a>
                        <a href="#" class="item-3 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-9.jpg') }}" src="{{ URL::asset('/build/images/location/location-9.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">London, United Kingdom</h6>
                                <p class="mt-4 text-variant-1">321 Property</p>
                            </div>
                        </a>
                        <a href="#" class="item-4 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-10.jpg') }}" src="{{ URL::asset('/build/images/location/location-10.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">Connecticut, New England</h6>
                                <p class="mt-4 text-variant-1">220 Property</p>
                            </div>
                        </a>
                        <a href="topmap-grid.html" class="item-5 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-11.jpg') }}" src="{{ URL::asset('/build/images/location/location-11.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">Sydney, Australia</h6>
                                <p class="mt-4 text-variant-1">231 Property</p>
                            </div>
                        </a>
                        <a href="topmap-grid.html" class="item-6 box-location-v2 hover-img">
                            <div class="box-img img-style">
                                <img class="lazyload" data-src="{{ URL::asset('/build/images/location/location-12.jpg') }}" src="{{ URL::asset('/build/images/location/location-12.jpg') }}" alt="image-location">
                            </div>
                            <div class="content">
                                <h6 class="link">New Jersey, New York</h6>
                                <p class="mt-4 text-variant-1">234 Property</p>
                            </div>
                        </a>
                    </div>
            ...
            <section class="flat-section bg-primary-new">
                <div class="container">
                    ...
                    <div class="swiper tf-sw-mobile"  data-screen="991" data-preview="1" data-space="15">
                        <div class="tf-layout-mobile-lg lg-col-2 swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".1s">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-1.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-1.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                            ...
                            <div class="swiper-slide">
                                <div class="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".2s">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-2.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-2.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">Featured</li>
                            ...
                            <div class="swiper-slide">
                                <div class="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-3.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-3.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">Featured</li>
                            ...
                            <div class="swiper-slide">
                                <div class="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".4s">
                                    <div class="archive-top">
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                                <img class="lazyload" data-src="{{ URL::asset('/build/images/home/house-sm-4.jpg') }}" src="{{ URL::asset('/build/images/home/house-sm-4.jpg') }}" alt="img-property">
                                            </div>
                                            <div class="top">
                                                <ul class="d-flex gap-6 flex-wrap">
                                                    <li class="flag-tag primary">Featured</li>
            ...
            <section class="flat-section flat-agents">
                <div class="container">
                        ...
                        <div class="tf-layout-mobile-sm xl-col-4 sm-col-2 swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".2s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/agents/agent-5.jpg') }}"  src="{{ URL::asset('/build/images/agents/agent-5.jpg') }}" alt="image-agent">
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".3s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/agents/agent-6.jpg') }}" src="{{ URL::asset('/build/images/agents/agent-6.jpg') }}" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                                    ...
                                    <div class="content">
                                        <div class="info">
                                            <h5><a class="link" href="#">Marvin McKinney</a></h5>
                                            <p class="text-variant-1">Administrative Staff</p>
                                        </div>
                                        <div class="box-icon">
                                            <span class="icon icon-phone"></span>
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/agents/agent-7.jpg') }}"  src="{{ URL::asset('/build/images/agents/agent-7.jpg') }}" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                                    ...
                                    <div class="content">
                                        <div class="info">
                                            <h5 class="link"><a class="link" href="#">Wade Warren</a></h5>
                                            <p class="text-variant-1">Administrative Staff</p>
                                        </div>
                                        <div class="box-icon">
                                            <span class="icon icon-phone"></span>
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".5s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/agents/agent-8.jpg') }}"  src="{{ URL::asset('/build/images/agents/agent-8.jpg') }}" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                                    ...
                                    <div class="content">
                                        <div class="info">
                                            <h5><a class="link" href="#">Devon Lane</a></h5>
                                            <p class="text-variant-1">Administrative Staff</p>
                                        </div>
                                        <div class="box-icon">
                                            <span class="icon icon-phone"></span>
                    ...
                    <p class="text-center desc body-2 text-variant-3">Become an agent and get the commission you deserve. <a href="contact.html" class="text-primary"> Contact us</a></p>
                </div>
            </section>
            <!-- End Agents -->
            <!-- Testimonial -->
            <section class="flat-section bg-primary-new flat-testimonial">
                ...
                <div class="swiper tf-sw-testimonial" data-preview="4.5" data-tablet="2" data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="30" data-centered="true" data-loop="true">
                        ...
                        <div class="swiper-wrapper wow fadeInUp" data-wow-delay=".2s">
                            <div class="swiper-slide">
                                <a href="blog-detail.html" class="flat-blog-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/blog/blog-5.jpg') }}" src="{{ URL::asset('/build/images/blog/blog-5.jpg') }}" alt="img-blog">
                            ...
                            <div class="swiper-slide">
                                <a href="blog-detail.html" class="flat-blog-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/blog/blog-7.jpg') }}" src="{{ URL::asset('/build/images/blog/blog-7.jpg') }}" alt="img-blog">
                                        <span class="date-post">January 28, 2024</span>
                                    </div>
                                    <div class="content-box">
                                        <div class="post-author">
                            ...
                            <div class="swiper-slide">
                                <a href="blog-detail.html" class="flat-blog-item hover-img">
                                    <div class="img-style">
                                        <img class="lazyload" data-src="{{ URL::asset('/build/images/blog/blog-9.jpg') }}" src="{{ URL::asset('/build/images/blog/blog-9.jpg') }}" alt="img-blog">
                                        <span class="date-post">January 28, 2024</span>
                                    </div>
                                    <div class="content-box">
                                        <div class="post-author">
                ...
                <div class="top-footer">
                  <div class="container">
                    <div class="content-footer-top">
                        <div class="footer-logo"><a href="index.html"><img src="{{ URL::asset('/build/images/logo/logo-footer@2x.png') }}" alt="logo" width="166" height="48"></a></div>
                        <div class="wd-social">
                          <span>Follow Us:</span>
