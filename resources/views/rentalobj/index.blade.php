...
<section class="mx-5 bg-primary-new radius-30">
    <div class="flat-img-with-text">
        ...
        <div class="content-left img-animation wow">
            <img class="lazyload" data-src="{{ URL::asset('/build/images/banner/img-w-text1.jpg') }}" src="{{ URL::asset('/build/images/banner/img-w-text1.jpg') }}" alt="Expertise in Real Estate">
        </div>
        <!-- Rechte Inhalte -->
        <div class="content-right">
            <div class="box-title wow fadeInUp">
                <div class="text-subtitle text-primary">@autotranslate("Our Benefits", app()->getLocale())</div>
                <h3 class="title mt-4">@autotranslate("Why Choose HomeLengo", app()->getLocale())</h3>
                <p class="desc text-variant-1">@autotranslate("Discover how HomeLengo can simplify your real estate journey with unmatched expertise tailored solutions and a commitment to transparency.", app()->getLocale())</p>
            </div>
            <!-- Liste von Benefits -->
            <div class="flat-service wow fadeInUp" data-wow-delay=".2s">
                ...
                <a href="#" class="box-benefit hover-btn-view">
                    ...
                    <div class="content">
                        <h5 class="title">@autotranslate("Proven Expertise", app()->getLocale())</h5>
                        <p class="description">@autotranslate("Benefit from our extensive market knowledge and years of experience in successfully navigating the real estate landscape.", app()->getLocale())</p>
                    </div>
                </a>
                ...
                <a href="#" class="box-benefit hover-btn-view">
                    ...
                    <div class="content">
                        <h5 class="title">@autotranslate("Tailored Solutions", app()->getLocale())</h5>
                        <p class="description">@autotranslate("We create personalized strategies to align with your unique real estate needs, ensuring seamless transactions every time.", app()->getLocale())</p>
                    </div>
                </a>
                ...
                <a href="#" class="box-benefit hover-btn-view">
                    ...
                    <div class="content">
                        <h5 class="title">@autotranslate("Transparent Partnerships", app()->getLocale())</h5>
                        <p class="description">@autotranslate("Trust and integrity are at the core of our client relationships, ensuring open communication and dependable guidance.", app()->getLocale())</p>
                    </div>
                </a>
            </div>
            ...
            <div class="text-center mt-4">
                <a href="#"
                   ...
                   data-tracking='{
                    ...
                    @autotranslate("List Your Property for Free", app()->getLocale())
                </a>
            </div>
        </div>
    </div>
...
<script>
    ...
    new Swiper('.tf-sw-testimonial', {
        slidesPerView: 4.5, // Anpassen je nach gewünschter Vorschau
        spaceBetween: 30,
        centeredSlides: true,
        loop: true,
        pagination: {
