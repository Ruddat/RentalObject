        ...
        <div id="pagee" class="clearfix">
                            ...
                            <div class="inner-header">
                                <div class="inner-header-left">
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.html"><img id="trans-logo" src="images/logo/logo@2x-white.png" alt="logo" width="166" height="48"></a></div>
                                    </div>
                                                    ...
                                                    <ul class="navigation clearfix">
                                                        <li class="dropdown2 home current"><a href="#">Home</a>
                                                            <ul>
                                                                ...
                                                                <li class="current"><a href="home-05.html">Homepage 05</a></li>
            ...
            <section class="flat-spacing-service bg-primary-new">
                <div class="container">
                    <div class="box-title text-center wow fadeInUp">
                        ...
                        <h3 class="mt-4 title">Welcome the HomeLengo</h3>
                    </div>
            ...
            <section class="flat-section flat-recommended">
                <div class="container">
                    <div class="box-title text-center wow fadeInUp">
                        ...
                        <h3 class="title mt-4">Discover Homelengo’s Finest Properties for Your Dream Home</h3>
                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-15.jpg" src="images/home/house-15.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-13.jpg" src="images/home/house-13.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-14.jpg" src="images/home/house-14.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-16.jpg" src="images/home/house-16.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-17.jpg" src="images/home/house-17.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="homelengo-box">
                                            <div class="archive-top">
                                                <a href="property-details-v1.html" class="images-group">
                                                    <div class="images-style">
                                                        <img class="lazyload" data-src="images/home/house-18.jpg" src="images/home/house-18.jpg" alt="img">
                                                    </div>
                                                    <div class="top">
                                                        <ul class="d-flex gap-6">
                                                            <li class="flag-tag primary">Featured</li>
                ...
                <div class="container">
                    <div class="flat-img-with-text style-3 bg-primary-new">
                        <div class="content-left img-animation wow">
                            <img class="lazyload" data-src="images/banner/img-w-text6.jpg" src="images/banner/img-w-text6.jpg" alt="">
                        </div>
            ...
            <section class="mx-5 bg-primary-new radius-30">
                <div class="flat-img-with-text">
                    <div class="content-left img-animation wow">
                        <img class="lazyload" data-src="images/banner/img-w-text5.jpg" src="images/banner/img-w-text5.jpg" alt="">
                    </div>
                    <div class="content-right">
                        <div class="box-title wow fadeInUp">
                        ...
                        <div class="tf-layout-mobile-sm xl-col-4 sm-col-2 swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".2s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="images/agents/agent-5.jpg"  src="images/agents/agent-5.jpg" alt="image-agent">
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".3s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="images/agents/agent-6.jpg" src="images/agents/agent-6.jpg" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="images/agents/agent-7.jpg"  src="images/agents/agent-7.jpg" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                            ...
                            <div class="swiper-slide">
                                <div class="box-agent hover-img wow fadeInUp" data-wow-delay=".5s">
                                    <a href="#" class="box-img img-style">
                                        <img class="lazyload" data-src="images/agents/agent-8.jpg"  src="images/agents/agent-8.jpg" alt="image-agent">
                                        <ul class="agent-social">
                                            <li><span class="icon icon-facebook"></span></li>
                                            <li><span class="icon icon-x"></span></li>
                                            <li><span class="icon icon-linkedin"></span></li>
                ...
                <div class="container">
                    ...
                    <div class="tf-grid-layout xl-col-4 sm-col-2 wow fadeInUp" data-wow-delay=".2s">
                        <a href="blog-detail.html" class="flat-blog-item hover-img style-1">
                            <div class="img-style">
                                <img class="lazyload" data-src="images/blog/blog-20.jpg" src="images/blog/blog-20.jpg" alt="img-blog">
                            </div>
                        ...
                        <a href="blog-detail.html" class="flat-blog-item hover-img style-1">
                            <div class="img-style">
                                <img class="lazyload" data-src="images/blog/blog-21.jpg" src="images/blog/blog-21.jpg" alt="img-blog">
                            </div>
                            <span class="date-post">January 28, 2024</span>
                            <div class="content-box">
                        ...
                        <a href="blog-detail.html" class="flat-blog-item hover-img style-1">
                            <div class="img-style">
                                <img class="lazyload" data-src="images/blog/blog-22.jpg" src="images/blog/blog-22.jpg" alt="img-blog">
                            </div>
                            <span class="date-post">January 28, 2024</span>
                            <div class="content-box">
                        ...
                        <a href="blog-detail.html" class="flat-blog-item hover-img style-1">
                            <div class="img-style">
                                <img class="lazyload" data-src="images/blog/blog-23.jpg" src="images/blog/blog-23.jpg" alt="img-blog">
                            </div>
                            <span class="date-post">January 28, 2024</span>
                            <div class="content-box">
