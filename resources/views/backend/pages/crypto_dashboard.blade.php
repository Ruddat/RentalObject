                                        ...
                                        <td>
                                            <div class="position-relative">
                                                <div class="h-35 w-35 d-flex-center b-r-15 overflow-hidden bg-light-warning position-absolute">
                                                    <img src="{{asset('backend/assets/images/dashboard/analytics/bitcoin.png')}}" alt="" class="img-fluid">
                                                </div>
                                                <div class="ms-5">
                                                    <h6 class="mb-0">Bitcoin</h6>
                                                </div>
                    ...
                    <div class="card card-added">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{asset('backend/assets/images/dashboard/analytics/bg.png')}}" class="img-fluid" alt="">
                                <div>
...
@section('script')
    ...
    <!-- Crypto js-->
    <script src="{{asset('backend/assets/js/crypto_dashboard.js')}}"></script>
    <script src="{{asset('backend/assets/js/crypto_dashboard_chart.js')}}"></script>
