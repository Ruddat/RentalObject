                        ...
                        <div class="offcanvas offcanvas-end header-cart-canvas" tabindex="-1" id="cartcanvasRight"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    <div class="head-box">
                                        <img src="{{asset('../backend/assets/images/ecommerce/19.jpg')}}" alt="cart" class="h-50 me-3 b-r-10">
                                ...
                                Pink</span>
                                    ...
                                    <div class="head-box">
                                        <img src="{{asset('../backend/assets/images/ecommerce/13.jpg')}}" alt="cart"
                                ...
                                Gold</span>
                                    ...
                                    <div class="head-box">
                                        <img src="{{asset('../backend/assets/images/ecommerce/09.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                ...
                                White</span>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{asset('../backend/assets/images/ecommerce/23.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                ...
                                Blue</span>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{asset('../backend/assets/images/ecommerce/11.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                ...
                                White</span>
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        <img src="{{asset('../backend/assets/images/icons/cart.png')}}" alt="cart" class="w-50 h-50 mb-3">
                                        <div>
                        ...
                        <div class="offcanvas offcanvas-end header-notification-canvas" tabindex="-1"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                              ...
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('../backend/assets/images/ai_avtar/6.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                              ...
                              <span class="bg-light-dark h-35 w-35 d-flex-center b-r-10 position-relative">
                                <i class="ph-duotone  ph-truck f-s-18"></i>
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('../backend/assets/images/ai_avtar/2.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('../backend/assets/images/ai_avtar/5.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    class="position-absolute end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                              </span>
                                        </div>
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('../backend/assets/images/ai_avtar/1.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    class="position-absolute  end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                              </span>
                                        </div>
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        <img src="{{asset('../backend/assets/images/icons/bell.png')}}" class="w-50 h-50 mb-3 mt-2" alt="">
                                        <div>
                    ...
                    <li class="header-profile">
                        <a href="#" class="d-block head-icon" role="button" data-bs-toggle="offcanvas"
                           data-bs-target="#profilecanvasRight" aria-controls="profilecanvasRight">
                            <img src="{{asset('../backend/assets/images/avtar/woman.jpg')}}" alt="avtar" class="b-r-10 h-35 w-35">
                        </a>
